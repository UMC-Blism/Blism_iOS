...
class ReadOtherPersonLetterViewController: UIViewController {
    ...
    private let rootView : ReadOtherPersonLetterView
    
    init(type: LetterListType, letterId: Int64, replyId: Int64? = nil) {
        self.type = type
        self.letterId = letterId
        self.replyId = replyId
        rootView = ReadOtherPersonLetterView()
